...
pre_model = "./results/pacs/moco/moco_dl0.01_lr0.01_adamw_epoch999_loss0.67.pth"
embedding = "./results/pacs/embedding/feas_moco_512_l2.npy"
...
data_train = dict(
    ...
    domain_names='artpainting_cartoon_photo',
    use_moco_v3=False,
)
...
results = dict(
    output_dir="./results/pacs/{}".format(model_name),
)
